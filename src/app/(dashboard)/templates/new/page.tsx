...
const LAYOUTS: { slug: LayoutSlug; id: number; name: string; description: string; icon: React.ElementType; color: string }[] = [
  {
    slug: "layout_a",
    id: 1,
    name: "Layout A — Outreach",
    description: "Ideal for team introductions and outreach emails with team member cards, photos, and contact details.",
    icon: Users,
    color: "#2563EB",
  },
  {
    ...
    description: "Perfect for announcements with a highlights list, call-to-action, and clean numbered sections.",
    icon: Megaphone,
    color: "#7C3AED",
  },
];
...
export default function NewTemplatePage() {
  ...
  const [selected, setSelected] = useState<{ slug: LayoutSlug; id: number } | null>(null);
      ...
      <div className="flex flex-col h-screen">
        <div className="flex items-center gap-3 px-6 py-3 border-b bg-card">
          ...
          <span className="text-sm font-medium">
            New template — {selected.slug === "layout_a" ? "Layout A · Outreach" : "Layout B · Announcement"}
          </span>
        </div>
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-muted-foreground mb-8 text-sm">
        The layout is permanent after creation. To use a different layout, duplicate and recreate.
      </p>
      <motion.div
        ...
        {LAYOUTS.map((layout) => {
          ...
          return (
            <motion.button
              ...
              className="text-left border rounded-xl p-6 hover:border-primary hover:shadow-md transition-all group bg-card"
            >
              <div
